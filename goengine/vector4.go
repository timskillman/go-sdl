...
func (v Vec4) Min(other Vec4) Vec4 {
	return Vec4{math32.Min(v.X, other.X), math32.Min(v.Y, other.Y), math32.Min(v.Z, other.Z), math32.Min(v.W, other.W)}
}
...
func (v *Vec4) SetMin(other Vec4) {
	...
	v.W = math32.Min(v.W, other.W)
}

// Max returns max of this vector components vs. other vector.
func (v Vec4) Max(other Vec4) Vec4 {
	return Vec4{math32.Max(v.X, other.X), math32.Max(v.Y, other.Y), math32.Max(v.Z, other.Z), math32.Max(v.W, other.W)}
}
...
func (v Vec4) Floor() Vec4 {
	return Vec4{math32.Floor(v.X), math32.Floor(v.Y), math32.Floor(v.Z), math32.Floor(v.W)}
}
...
func (v Vec4) Ceil() Vec4 {
	return Vec4{math32.Ceil(v.X), math32.Ceil(v.Y), math32.Ceil(v.Z), math32.Ceil(v.W)}
}
...
func (v Vec4) MulMat4(m *Mat4s) Vec4 {
	return Vec4{m.m0*v.X + m.m4*v.Y + m.m8*v.Z + m.m12*v.W,
...
func (v *Vec4) SetAxisFromRotationMatrix(m *Mat4s) {
	...
	if (math32.Abs(m12-m21) < epsilon) && (math32.Abs(m13-m31) < epsilon) && (math32.Abs(m23-m32) < epsilon) {
		// singularity found
		// first check for identity matrix which must have +1 for all terms
		// in leading diagonal and zero in other terms

		if (math32.Abs(m12+m21) < epsilon2) && (math32.Abs(m13+m31) < epsilon2) && (math32.Abs(m23+m32) < epsilon2) && (math32.Abs(m11+m22+m33-3) < epsilon2) {
	...
	s := math32.Sqrt((m32-m23)*(m32-m23) + (m13-m31)*(m13-m31) + (m21-m12)*(m21-m12)) // used to normalize

	if math32.Abs(s) < 0.001 {
		s = 1
	}
	...
	v.Y = (m13 - m31) / s
	v.Z = (m21 - m12) / s
	v.W = math32.Acos((m11 + m22 + m33 - 1) / 2)
}
