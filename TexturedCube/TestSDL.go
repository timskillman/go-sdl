...
func main() {
	...
	scene.AddShape("plane1", planeShape, 5, 5, 0, vec3{7, -10, -20}, vec3{0, 0, 0}, 1, 0xff00ffff, "me.png")
	scene.AddShape("sphere1", sphereShape, 5, 0, 1, vec3{-7, 0, -20}, vec3{0, 0.5, 0.5}, 30, 0xff00ffff, "spanel.png")
	...
	scene.AddShape("cylinder1", cylinderShape, 3, 5, 20, vec3{0, 10, -20}, vec3{0, 0.5, 0.5}, 20, 0xff00ffff, "me.png")
